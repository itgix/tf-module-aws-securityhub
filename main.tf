# Enable SecurityHub in management account
...
resource "aws_securityhub_standards_subscription" "aws_security_best_practices" {
  count         = var.enable_security_hub && var.enable_aws_security_best_practices_scanning ? 1 : 0
...
resource "aws_securityhub_standards_subscription" "cis_aws_foundations_security_benchmark_1_2" {
  count         = var.enable_security_hub && var.enable_cis_aws_foundations_benchmark_v1_2_scanning ? 1 : 0
...
resource "aws_securityhub_standards_subscription" "cis_aws_foundations_security_benchmark_1_4" {
  count         = var.enable_security_hub && var.enable_cis_aws_foundations_benchmark_v1_4_scanning ? 1 : 0
...
resource "aws_securityhub_standards_subscription" "pci_dss_compliance" {
  count         = var.enable_security_hub && var.enable_pci_dss_complaince_scanning ? 1 : 0
...
resource "aws_securityhub_standards_subscription" "nist_sp_800_53_rev_5" {
  count         = var.enable_security_hub && var.enable_nist_sp_800_compliance_scanning ? 1 : 0
